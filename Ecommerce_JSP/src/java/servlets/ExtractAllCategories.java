 ...
 * @author islam
 */
public class ExtractAllCategories extends HttpServlet {
   ...
   ArrayList<Categories> categories=user.getAllCategories();
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExtractAllCategories</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ExtractAllCategories at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
